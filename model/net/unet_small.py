...
class UNet_small(BaseNet):
    ...
    def __init__(self, in_channels, out_channels, num_features=[64, 128, 256, 512, 1024]):
        ...
        self.up_block1 = _UpBlock(num_features[3], num_features[2])
        self.up_block2 = _UpBlock(num_features[2], num_features[1])
        self.up_block3 = _UpBlock(num_features[1], num_features[0])
