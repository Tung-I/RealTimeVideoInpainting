...
from net.utils.spectral_norm import spectral_norm as _spectral_norm
...
class InpaintGenerator(BaseNetwork):
    def __init__(self, init_weights=True, output_size=(256, 256)):
    ...
    def forward(self, masked_frames):
        ...
        trans_feat = trans_feat.view(b*t, c, -1).permute(0, 2, 1)  # [b*t, h'w', c]
